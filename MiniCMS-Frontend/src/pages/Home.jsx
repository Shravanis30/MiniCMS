        ...
        <div className="space-y-10">
          ...
          <div className="bg-gray-100 p-6 rounded shadow">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button className="bg-blue-600 text-white p-4 rounded hover:bg-blue-500">Create New Post</button>
              <button className="bg-green-600 text-white p-4 rounded hover:bg-green-500">Upload Image</button>
